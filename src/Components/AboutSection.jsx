            ...
            <div className="row">
                <div className="col-md-12 mx-auto text-justify">
                    ...
                    <p>I am Junior Fullstack Developer able to build low-latency, high-availability, and performant applications
                        from the ground up - from concept, navigation, layout and programming to UX and SEO. Skilled at writing well-designed, testable, reusable and efficient code using
                    ...
                    <p>I am currently a software developer at <a target="_blank" href="https://broadspectrumltd.com/" rel="noreferrer">Broadspectrum Ghana</a>, where I help build payment gateways. 
